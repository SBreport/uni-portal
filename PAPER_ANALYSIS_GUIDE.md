...
| 근거 수준 | 원고 작성 시 활용법 |
|----------|-------------------|
| ★★★★★~★★★★☆ (4~5) | **적극 인용 가능**. "임상 연구에 따르면~", "연구 결과~"로 근거로 직접 제시 |
| ★★★☆☆ (3) | **참고 인용 가능**. "관련 연구에서~"로 보조 근거로 활용 |
| ★★☆☆☆ (2) | **보조 참고**. "일부 사례에서~"로 톤 조절 필요. 단독 근거로 부적합 |
| ★☆☆☆☆ (1) | **배경 정보**. "전문가 의견으로는~"으로 참고 수준. 수치 인용 지양 |
| ☆☆☆☆☆ (0) | **사용 지양**. 근거로 활용하기 어려움 |

> **핵심 원칙**: 별표가 높을수록 "연구 결과"로 강하게 인용 가능, 낮을수록 "참고 의견" 수준으로 톤을 낮춰야 합니다.
> 가능하면 ★3 이상 논문을 주요 근거로, ★1~2는 보충 설명용으로 활용하세요.
